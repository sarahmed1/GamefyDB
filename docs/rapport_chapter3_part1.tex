% ============================================================
%  GamefyDB — PFE Report  |  Chapter 3, Part 1
%  Sprint 1: Data Ingestion and Cleaning — Ingestion Stage
...
Sprint~1 marks the beginning of the implementation phase. Its scope covers the
first two stages of the GamefyDB pipeline — ingestion and cleaning — corresponding
to user stories US-01 through US-04 from the product backlog. At the end of this
sprint the pipeline is able to read all four source \texttt{.xls} files, strip
every formatting artefact, and produce a set of fully typed DataFrames ready for
dimensional modelling in Sprint~2.
...
for names and categorical labels.
