...
\begin{table}[H]
  ...
  \begin{tabular}{lrrrl}
    ...
    \hline
    Revenue (TND, daily)    & $-5.213$ & $<0.001$ & $-2.864$ & stationary \\
    Session volume (daily)  & $-4.973$ & $<0.001$ & $-2.864$ & stationary \\
    Member activity (weekly)& $-5.957$ & $<0.001$ & $-2.877$ & stationary \\
    \hline
  \end{tabular}
  \caption{ADF stationarity test results for the three forecast series
           Source: \texttt{output/forecasts/stationarity\_tests.csv}.%
