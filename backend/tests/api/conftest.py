...
from backend.apps.api.auth.manager import UserManager
from backend.apps.api.db import Base, get_async_session
from backend.apps.api.main import app
from backend.apps.api.models import User
from backend.apps.api.schemas import UserCreate
...
from backend.apps.api.services import data_cache as _data_cache_mod
from backend.apps.api.services.data_cache import cache as data_cache
