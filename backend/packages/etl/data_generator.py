...
Run:
    python -m packages.etl.data_generator
"""
...
from backend.packages.analytics.weather import fetch_weather, weather_multiplier
...
def generate_augment(excel_dir: str = 'excel', months_back: int = 24) -> None:
    ...
    """
    from backend.packages.etl.pipeline import load_and_clean_cash
...
def generate_all(excel_dir: str = 'excel') -> None:
    from backend.packages.etl.pipeline import (
